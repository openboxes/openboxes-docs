---
description: How this guide is built, and how to submit a change to it.
---

# Improve These Docs

This guide is built using [GitBook](https://www.gitbook.com/) and is synchronized with the markdown files in the [./contributor-guide](https://github.com/openboxes/openboxes-docs/tree/main/contributor-guide) folder of the openboxes-docs repository. The page order and grouping you see in the sidebar comes from [SUMMARY.md](https://github.com/openboxes/openboxes-docs/blob/main/contributor-guide/SUMMARY.md) — if you add a page, add it there too or it won't be published.
...
If you're documenting the application itself rather than how to contribute to it — user guides, administrator guides, the API reference — that lives in a separate site, [docs.openboxes.com](https://docs.openboxes.com), built from the `docs/` folder of the [openboxes repository](https://github.com/openboxes/openboxes).
