---
description: Building and running the application on your own machine.
---
...
If you're a system administrator looking to deploy the application to a production server, read the [installation documentation on docs.openboxes.com](https://docs.openboxes.com/en/develop/admin-guide/installation/) instead. If you just want a running instance and don't need to modify the code, [running with Docker](running-with-docker.md) is quicker.
