---
description: Running the frontend, backend and end-to-end test suites.
---
...
If you're interested in writing new automation tests but are unsure where to start, feel free to reach out to us on [Slack](http://slack-signup.openboxes.com), and we can help you pick a feature to test.
