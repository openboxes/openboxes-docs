---
description: Warehouse and codebase terms you'll run into around OpenBoxes.
---
...
These come up when reading the source or a pull request. See [How OpenBoxes Works](../how-openboxes-works/) for how they fit together.

* **Controller**: Files under `/grails-app/controllers`. The entrypoints for backend APIs.
* **Service**: Files under `/grails-app/services`. Classes that hold the main business logic for our APIs.
...
* **GSP**: Groovy Server Page. The templating technology used by our older, pre-React features.
